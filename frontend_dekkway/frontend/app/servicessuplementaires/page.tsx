          ...
          <Link href="/demenagement" passHref>
            ...
            >
              <div className="flex items-center w-full md:w-auto">
                ...
                />
                <div className="ml-4">
                  <h2 className="text-lg md:text-xl font-semibold text-[#014F86]">Déménagement</h2>
                </div>
              </div>
          ...
          <Link href="../nettoyage" passHref>
            ...
            >
              <div className="flex items-center w-full md:w-auto">
                ...
                />
                <div className="ml-4">
                  <h2 className="text-lg md:text-xl font-semibold text-[#014F86]">Nettoyage</h2>
                </div>
              </div>
              <div className="w-20 h-20 md:w-24 md:h-24 mt-4 md:mt-0 md:ml-4 border-2 border-[#014F86] rounded-xl overflow-hidden">
                <img
          ...
          <Link href="/transport" passHref>
            ...
            >
              <div className="flex items-center w-full md:w-auto">
                ...
                />
                <div className="ml-4">
                  <h2 className="text-lg md:text-xl font-semibold text-[#014F86]">Transport</h2>
                </div>
              </div>
              <div className="w-20 h-20 md:w-24 md:h-24 mt-4 md:mt-0 md:ml-4 border-2 border-[#014F86] rounded-xl overflow-hidden">
                <img
          ...
          <Link href="/" passHref>
            ...
            >
              <div className="flex items-center w-full md:w-auto">
                ...
                />
                <div className="ml-4">
                  <h2 className="text-lg md:text-xl font-semibold text-[#014F86]">Non, merci</h2>
                </div>
              </div>
            </motion.label>
          </Link>
