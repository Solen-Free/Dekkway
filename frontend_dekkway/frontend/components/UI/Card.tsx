...
//   location: string;
//   price: string;
//   isOnFavoritesPage?: boolean; // Nouvelle prop pour désactiver le cœur
//   onRemove?: (id: string) => void; // Fonction pour supprimer le logement
// }

// const Card: React.FC<CardProps> = ({ id, image, title, location, price, isOnFavoritesPage = false, onRemove }) => {
...
//     if (isOnFavoritesPage) return; // Désactiver le cœur sur la page des favoris
...
//   // Gérer la suppression du logement des favoris
...
//     // Appeler la fonction onRemove pour supprimer le logement de l'interface
//     if (onRemove) {
//       onRemove(id);
//     }
...
//             !isOnFavoritesPage ? 'hover:bg-[#FC9B89] active:bg-[#FC9B89] cursor-pointer' : 'cursor-not-allowed'
//           }`}
//           onClick={!isOnFavoritesPage ? toggleFavorite : undefined} // Désactiver le clic sur la page des favoris
//         >
//           <Heart
...
//         {isFavorite && (
//           <div
//             className="absolute top-3 left-3 bg-white rounded-full p-2 shadow-md hover:bg-red-500 cursor-pointer"
...
//         {/* Notification au-dessus de l'image */}
//         {showNotification && (
//           <div className="absolute top-0 left-0 w-full bg-green-500 text-white px-4 py-2 text-center rounded-t-lg">
//             {notificationMessage}
//           </div>
//         )}
//       </div>
