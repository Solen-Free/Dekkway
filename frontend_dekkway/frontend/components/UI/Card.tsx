...
const Card: React.FC<CardProps> = ({ image, title, location, price }) => {
  return (
    <div className="shadow-lg rounded-2xl overflow-hidden w-60 border-2 border-[#FC9B89] relative">
      {/* Image */}
      ...
      <div className="flex justify-between items-baseline">
        <h3 className="text-[14px] font-bold text-left text-black">{title}</h3>
      ...
      {/* Bouton Détails */}
      <div className="pb-2 pt-3 mt-2 flex justify-center">
