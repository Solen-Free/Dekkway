  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto bg-white p-6 sm:p-8 rounded-lg shadow-md">
        <div className="prose prose-sm text-gray-700 text-xs sm:text-sm leading-tight">
          {/* Section 1 : Collecte des Informations */}
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">1. Collecte des Informations</h2>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">1.1. Informations Personnelles</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">1.2. Données d'Utilisation</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">1.3. Données Techniques</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">1.4. Cookies et Technologies Similaires</h3>
          <p className="mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">2. Utilisation des Informations</h2>
          <p className="mb-4">
            Nous utilisons les informations collectées pour les finalités suivantes :
          </p>

          <h3 className="text-md font-semibold text-[#014F86] mb-2">2.1. Fournir et Maintenir nos Services</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">2.2. Personnaliser l'Expérience Utilisateur</h3>
          <p className="mb-4">
            Nous utilisons vos informations pour :
          </p>
          <ul className="list-disc list-inside mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">2.3. Analyser et Améliorer nos Services</h3>
          <p className="mb-4">
            Nous utilisons vos informations pour :
          </p>
          <ul className="list-disc list-inside mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">2.4. Sécurité et Conformité</h3>
          <p className="mb-4">
            Nous utilisons vos informations pour :
          </p>
          <ul className="list-disc list-inside mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">3. Partage des Informations</h2>
          <p className="mb-4">
            Nous ne partageons vos informations personnelles qu'avec votre consentement ou dans les cas suivants :
          </p>

          <h3 className="text-md font-semibold text-[#014F86] mb-2">3.1. Avec des Fournisseurs de Services</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">3.2. Pour des Raisons Légales</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">3.3. En Cas de Fusion ou d'Acquisition</h3>
          <p className="mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">4. Sécurité des Données</h2>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">4.1. Chiffrement des Données</h3>
          <p className="mb-4">
            Nous utilisons des protocoles de chiffrement pour protéger vos informations pendant leur transmission et leur stockage.
          </p>

          <h3 className="text-md font-semibold text-[#014F86] mb-2">4.2. Contrôle d'Accès</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">4.3. Surveillance et Détection</h3>
          <p className="mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">5. Vos Droits</h2>
          <p className="mb-4">
            En tant qu'utilisateur, vous avez des droits concernant vos données personnelles. Voici les droits que vous pouvez exercer :
          </p>

          <h3 className="text-md font-semibold text-[#014F86] mb-2">5.1. Droit d'Accès</h3>
          <p className="mb-4">
            Vous pouvez demander une copie des informations que nous détenons sur vous.
          </p>

          <h3 className="text-md font-semibold text-[#014F86] mb-2">5.2. Droit de Rectification</h3>
          <p className="mb-4">
            Vous pouvez demander la correction de données inexactes ou incomplètes.
          </p>

          <h3 className="text-md font-semibold text-[#014F86] mb-2">5.3. Droit à l'Effacement</h3>
          <p className="mb-4">
            Vous pouvez demander la suppression de vos données dans certaines circonstances.
          </p>

          <h3 className="text-md font-semibold text-[#014F86] mb-2">5.4. Droit d'Opposition</h3>
          <p className="mb-4">
            Vous pouvez vous opposer au traitement de vos données pour des raisons spécifiques.
          </p>

          <h3 className="text-md font-semibold text-[#014F86] mb-2">5.5. Droit à la Portabilité</h3>
          <p className="mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">6. Conservation des Données</h2>
          <p className="mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">7. Cookies et Technologies Similaires</h2>
          <p className="mb-4">
            Nous utilisons des cookies pour améliorer votre expérience utilisateur. Voici les types de cookies que nous utilisons :
          </p>

          <h3 className="text-md font-semibold text-[#014F86] mb-2">7.1. Cookies Essentiels</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">7.2. Cookies de Performance</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">7.3. Cookies de Fonctionnalité</h3>
          <p className="mb-4">
          ...
          <h3 className="text-md font-semibold text-[#014F86] mb-2">7.4. Cookies Publicitaires</h3>
          <p className="mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">8. Transferts Internationaux de Données</h2>
          <p className="mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">9. Modifications de la Politique de Confidentialité</h2>
          <p className="mb-4">
          ...
          {/* Annexe : Définitions */}
          <h2 className="text-lg font-semibold text-[#014F86] mb-2">Annexe : Définitions</h2>
          <p className="mb-4">
